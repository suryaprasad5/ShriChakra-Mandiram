...
// Deities with photos — filename maps to public/images/deities/
const pantheon = [
  {
...
// Placeholder-only deities (photos coming soon)
const placeholders = [
  'SHREEDAKSHINAMURTHY',
  'SHREEHAYAGREEVA',
  'SHREESATYANARAYANA',
...
function DeityPhoto({ name, file, desc }) {
  const basePath = process.env.GITHUB_PAGES !== 'false' ? '/ShriChakra-Mandiram' : '';
  return (
    <article className="deity-card fade-in">
      <div className="card-thumb" style={{ padding: 0, overflow: 'hidden', height: '260px', position: 'relative' }}>
        <img
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="deity-feature-layout fade-in">
            ...
            {/* Two photos side by side — Mahameru + Lalitha */}
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
              <div style={{ flex: '1', minWidth: '140px', maxWidth: '220px' }}>
                <div style={{ height: '280px', overflow: 'hidden', border: '1px solid rgba(201,146,42,0.3)' }}>
                  <img
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', marginTop: '1.5rem' }}>
                <div><span style={{ fontFamily: 'var(--font-sub)', fontSize: '0.72rem', color: 'var(--gold)', letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginBottom: '0.2rem' }}>Also Known As</span><span style={{ color: 'var(--text-muted)' }}>Lalitha, Bala, Kamakshi, Rajeshwari</span></div>
                <div><span style={{ fontFamily: 'var(--font-sub)', fontSize: '0.72rem', color: 'var(--gold)', letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginBottom: '0.2rem' }}>Yantra</span><span style={{ color: 'var(--text-muted)' }}>Shreechakra Mahameru (3D)</span></div>
                <div><span style={{ fontFamily: 'var(--font-sub)', fontSize: '0.72rem', color: 'var(--gold)', letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginBottom: '0.2rem' }}>Mantra</span><span style={{ color: 'var(--text-muted)' }}>Panchadasi · Shodashi</span></div>
              </div>
            </div>
          </div>
        </div>
